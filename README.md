# audiograbd
The Audiograb is an embedded wireless wildlife monitoring system, currently in development by students at NTNU for the Norwegian Institute of Nature Research ([NINA](https://www.nina.no/english/Home)). This repository contains the source code Audiograb daemon, ``audiograbd``. The PCB design files are available [here](https://github.com/oveljosland/audiograb-pcb).
